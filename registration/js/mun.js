...
const COMMITTEES = [
    ...
    },
    {
        ...
        name: 'UNHRC',
        portfolios: [
            { id: '238', name: 'Algeria', status: 'available' },
            { id: '239', name: 'Benin', status: 'available' },
            { id: '240', name: 'Burundi', status: 'available' },
            { id: '241', name: 'Cameroon', status: 'available' },
            { id: '242', name: 'Côte d’Ivoire', status: 'available' },
            { id: '243', name: 'Eritrea', status: 'available' },
            { id: '244', name: 'Gambia', status: 'available' },
            { id: '245', name: 'Ghana', status: 'available' },
            { id: '246', name: 'Kenya', status: 'available' },
            { id: '247', name: 'Malawi', status: 'available' },
            { id: '248', name: 'Morocco', status: 'available' },
            { id: '249', name: 'Somalia', status: 'available' },
            { id: '250', name: 'South Africa', status: 'available' },
            { id: '251', name: 'Bangladesh', status: 'available' },
            { id: '252', name: 'China', status: 'available' },
            { id: '253', name: 'Indonesia', status: 'available' },
            { id: '254', name: 'Japan', status: 'available' },
            { id: '255', name: 'Kuwait', status: 'available' },
            { id: '256', name: 'Kyrgyzstan', status: 'available' },
            { id: '257', name: 'Maldives', status: 'available' },
            { id: '258', name: 'Pakistan', status: 'available' },
            { id: '259', name: 'Qatar', status: 'available' },
            { id: '260', name: 'Republic of Korea (South Korea)', status: 'available' },
            { id: '261', name: 'Thailand', status: 'available' },
            { id: '262', name: 'United Arab Emirates', status: 'available' },
            { id: '263', name: 'Vietnam', status: 'available' },
            { id: '264', name: 'Albania', status: 'available' },
            { id: '265', name: 'Bulgaria', status: 'available' },
            { id: '266', name: 'Czechia', status: 'available' },
            { id: '267', name: 'Georgia', status: 'available' },
            { id: '268', name: 'Romania', status: 'available' },
            { id: '269', name: 'Ukraine', status: 'available' },
            { id: '270', name: 'Argentina', status: 'available' },
            { id: '271', name: 'Bolivia', status: 'available' },
            { id: '272', name: 'Brazil', status: 'available' },
            { id: '273', name: 'Chile', status: 'available' },
            { id: '274', name: 'Colombia', status: 'available' },
            { id: '275', name: 'Costa Rica', status: 'available' },
            { id: '276', name: 'Cuba', status: 'available' },
            { id: '277', name: 'Dominican Republic', status: 'available' },
            { id: '278', name: 'Belgium', status: 'available' },
            { id: '279', name: 'Finland', status: 'available' },
            { id: '280', name: 'France', status: 'available' },
            { id: '281', name: 'Germany', status: 'available' },
            { id: '282', name: 'Luxembourg', status: 'available' },
            { id: '283', name: 'Netherlands', status: 'available' },
            { id: '284', name: 'United Kingdom', status: 'available' }
        ]
    },
    {
        id: 'who',
